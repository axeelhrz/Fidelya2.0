...
export default function HomePage() {
  ...
  const fullText = 'Gestioná tu asociación y fidelizá a tus socios.';
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-sky-200/50 hover:scale-105 hover:bg-white/80 transition-all duration-500 group">
                <h4 className="text-xl font-semibold text-sky-700 mb-4 group-hover:text-sky-600">Aumentá la recaudación sin perseguir a nadie</h4>
                <p className="text-slate-600 group-hover:text-slate-700 transition-colors duration-300">Automatiza el cobro de cuotas con recordatorios personalizados.</p>
              </div>
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-celestial-200/50 hover:scale-105 hover:bg-white/80 transition-all duration-500 group">
                <h4 className="text-xl font-semibold text-celestial-700 mb-4 group-hover:text-celestial-600">Fidelizá a tus socios con beneficios reales</h4>
                <p className="text-slate-600 group-hover:text-slate-700 transition-colors duration-300">Los socios que están al día acceden a descuentos exclusivos en comercios adheridos.</p>
              </div>
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-sky-200/50 hover:scale-105 hover:bg-white/80 transition-all duration-500 group">
                <h4 className="text-xl font-semibold text-sky-700 mb-4 group-hover:text-sky-600">Gestión simple, desde una plataforma que entiende tu realidad</h4>
                <p className="text-slate-600 group-hover:text-slate-700 transition-colors duration-300">Agregá socios, registrá pagos, cargá beneficios y visualizá todo en un panel claro y desde cualquier dispositivo.</p>
              </div>
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-celestial-200/50 hover:scale-105 hover:bg-white/80 transition-all duration-500 group">
                <h4 className="text-xl font-semibold text-celestial-700 mb-4 group-hover:text-celestial-600">Conectá tu comunidad con comercios de confianza</h4>
                <p className="text-slate-600 group-hover:text-slate-700 transition-colors duration-300">Fidelya crea un puente entre tu asociación y comercios que quieren ganar clientes fidelizados.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`transition-all duration-1200 ease-out ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'}`} style={{ transitionDelay: '2.1s' }}>
          <div className="bg-gradient-to-r from-sky-500/10 to-celestial-500/10 rounded-3xl p-12 border border-sky-200/30 hover:scale-105 transition-all duration-500 group">
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto group-hover:text-slate-700 transition-colors duration-300">
              Únete a las asociaciones y comercios que ya confían en Fidelya para gestionar tus socios y fidelizarlos con beneficios.
            </p>
