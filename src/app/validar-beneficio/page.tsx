  ...
  const handleValidateBenefit = async (beneficio: Beneficio) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.data) {
          const { beneficio: beneficioData, comercio: comercioData } = result.data;
          
          // Toast con información simplificada - sin mencionar ahorro
          toast.success(
            `🎉 ¡Validación exitosa!\n` +
                ...
                <div className="bg-green-50 border border-green-200 rounded-2xl p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      {user.asociacionId && (
                        <p className="text-green-600 text-sm">
                          Nombre: {user.nombre || 'Asociado'} - Estado: {user.estado || 'Activo'}
                        </p>
                      )}
                    </div>
                  </div>
                ...
                <div className="bg-red-50 border border-red-200 rounded-2xl p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      {user.asociacionId && (
                        <p className="text-red-600 text-sm">
                          Nombre: {user.nombre || 'Asociado'} - Estado: {user.estado || 'Desconocido'}
                        </p>
                      )}
                    </div>
                  </div>
