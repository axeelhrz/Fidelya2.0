...
export const BeneficiosList: React.FC<BeneficiosListProps> = ({
  ...
  // Función para manejar la validación de beneficios
  const handleValidarBeneficio = async (beneficioId: string, comercioId: string) => {
    if (userRole === 'socio') {
        ...
        <div className="px-6 py-4 bg-slate-50 border-t border-slate-100">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              {userRole === 'socio' && (
                <Button
                  onClick={() => handleValidarBeneficio(beneficio.id, beneficio.comercioId)}
