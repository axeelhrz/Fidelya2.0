  ...
  useEffect(() => {
    if (isOnline && error && retryCount < 3) {
      const timer = setTimeout(() => {
        console.log('🔄 Auto-retry on connection restore');
        handleRefresh();
    ...
    return (
      <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/50 p-12">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-gray-600 mb-4">Obteniendo historial completo</p>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex items-center space-x-2 text-sm mb-6">
            {isOnline ? (
              ...
              <>
                <WifiOff className="w-4 h-4 text-red-500" />
                <span className="text-red-600">Sin conexión - Verifica tu internet</span>
              </>
            )}
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              disabled={loading}
              className="px-6 py-3 bg-blue-500 text-white rounded-2xl hover:bg-blue-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
            >
