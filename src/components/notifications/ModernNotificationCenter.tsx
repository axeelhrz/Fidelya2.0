...
export const ModernNotificationCenter = () => {
  ...
  // Initialize system templates on mount (only once)
  useEffect(() => {
    const initializeTemplates = async () => {
      if (templatesInitialized) return;
      
      try {
        console.log('🔧 Inicializando plantillas del sistema...');
        await notificationTemplatesService.initializeSystemTemplates();
        setTemplatesInitialized(true);
        console.log('✅ Plantillas del sistema inicializadas correctamente');
      } catch (error) {
        console.error('❌ Error inicializando plantillas del sistema:', error);
        // No mostrar error al usuario, las plantillas se pueden crear manualmente
      }
    };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="mb-6 flex items-center justify-between">
                  ...
                  >
                    ...
                    <span className="font-medium">Usar Plantillas</span>
                  </button>
                </div>
      ...
      {/* Create Notification Dialog with Templates */}
