import { z } from 'zod';
import { VALIDATION_RULES, USER_ROLES } from '@/lib/constants';
...
export const emailSchema = z
  ...
  .refine((val) => VALIDATION_RULES.email.test(val), 'Email inválido');

// Password validation schema
export const passwordSchema = z
  .string()
  .min(VALIDATION_RULES.password.minLength, `La contraseña debe tener al menos ${VALIDATION_RULES.password.minLength} caracteres`);
...
// Phone validation schema with automatic Argentina formatting
